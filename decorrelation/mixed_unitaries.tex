...
\end{align}
And so we see that Lemma 2 generalizes. In all of the above $||\cdot||$ is the Schatten 0-norm, which we will use to upper bound the 1-norm (and hence diamond norm) in the following.
